...
},
{
  ...
  pergunta: {
    ...
    es: "Un paciente de 68 años es admitido con disminución súbita del nivel de conciencia. Presión arterial: 220/110 mmHg. La TC muestra hematoma intracerebral espontáneo en el putamen derecho, de 4,2 cm, sin desviación de línea media. Pupilas isocóricas, GCS 10. ¿Cuál es la conducta inicial más apropiada?"
  },
  alternativas: [
    {
      texto: {
...
},
{
  ...
  pergunta: {
    ...
    es: "Un paciente de 49 años se encuentra en el día 5 tras hemorragia subaracnoidea aneurismática. Presenta leve deterioro del nivel de conciencia. El Doppler transcraneal muestra velocidad media de 160 cm/s en la ACM derecha e índice de Lindegaard > 3. ¿Cuál es la mejor interpretación y conducta?"
  },
  alternativas: [
    {
      texto: {
...
},
{
  ...
  correta: 2,
  pergunta: {
    pt: "Mulher de 61 anos apresenta hidrocefalia aguda obstrutiva após hemorragia intraventricular. É submetida a derivação ventricular externa (DVE) com boa resposta. Após 12 dias, o débito permanece elevado e não há previsão de retirada. Qual das alternativas abaixo é mais apropriada?",
...
},
{
  ...
  correta: 0,
  pergunta: {
    pt: "Paciente de 48 anos em reabilitação após AVC isquêmico extenso no hemisfério esquerdo. Apresenta disartria moderada e hemiparesia direita. Equipe multiprofissional inicia estimulação precoce e fisioterapia intensiva. Qual afirmação abaixo sobre neuroplasticidade está mais correta?",
    ...
    es: "Un paciente de 48 años está en rehabilitación tras un ictus isquémico extenso en el hemisferio izquierdo. Presenta disartria moderada y hemiparesia derecha. Se inicia estimulación temprana y fisioterapia intensiva. ¿Cuál afirmación sobre neuroplasticidad es más correcta?"
  },
  alternativas: [
    {
      texto: {
...
},
{
  ...
  alternativas: [
    ...
    },
    {
      ...
      explicacao: {
        pt: "Hiperventilação não trata status epilepticus e não é indicada nesse contexto.",
...
bancoQuestoes.adicionarBanco(bancoNeuroModerado);
